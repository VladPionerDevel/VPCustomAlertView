#
# Be sure to run `pod lib lint VPCustomAlertView.podspec' to ensure this is a
...
Creating your own pretti and functional Alert View
  ...
  s.source           = { :git => 'https://github.com/VladPionerDevel/VPCustomAlertView.git', :tag => '1.0.2' }
  ...
  # s.resource_bundles = {
  #   'VPCustomAlertView' => ['VPCustomAlertView/Assets/*.png']
  # }
